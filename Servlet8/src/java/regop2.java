 ...
 * @author Aniket
 */
@WebServlet(urlPatterns = {"/regop2"})
public class regop2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet regop2</title>");            
            out.println("</head>");
            out.println("<body>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(regop2.class.getName()).log(Level.SEVERE, null, ex);
